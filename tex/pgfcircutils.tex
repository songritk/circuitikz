...
\pgfutil@protect\def\ctikzsubcircuitdef#1#2#3{%
...
\pgfutil@protect\def\pgf@circ@set@list#1#2%
  {%
...
\pgfutil@protect\def\pgf@circ@if@num@in@list#1#2%
  {%
...
\pgfutil@protect\def\pgf@circ@if@num@in@list@a#1#2%
...
\pgfutil@protect\def\pgf@circ@if@num@in@list@b#1#2%
  {%
    \begingroup
