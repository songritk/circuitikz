...
\pgfutil@protect\def\pgf@circ@make@dippin@anchor#1%
  {%
...
% QFP (quad flat package) chips
% helper macro to set the anchors inside a loop (to expand the current count)
\pgfutil@protect\def\pgf@circ@make@qfppin@anchor#1%
  {%
...
% left
\pgfutil@protect\def\pgf@circ@make@muxdemux@L@anchor#1%
  {%
...
% right
\pgfutil@protect\def\pgf@circ@make@muxdemux@R@anchor#1%
  {%
...
% bottom
\pgfutil@protect\def\pgf@circ@make@muxdemux@B@anchor#1%
  {%
...
% top
\pgfutil@protect\def\pgf@circ@make@muxdemux@T@anchor#1%
  {%
